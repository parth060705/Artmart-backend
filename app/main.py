...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:5173","https://art-mart-sigma.vercel.app","https://websocketking.com",'https://art-mart-git-tryouts-parth-gharats-projects.vercel.app',"https://*.app.github.dev",],    
